...
class PortfolioEditScreen extends StatelessWidget {
  const PortfolioEditScreen({Key? key}) : super(key: key);
...
class _PorfolioEditForm extends StatefulWidget {
  @override
  __PorfolioEditFormState createState() => __PorfolioEditFormState();
}

class __PorfolioEditFormState extends State<_PorfolioEditForm> {
